 ...
 * v.2 - added DST (summer/winter time) switch
 * v.2a - clear the skech by unusefull commands + added 12/24-hout format switch
 * v.2b - reboot the display at 00:00:00 (after near 72 hour display was freeze.. more times)
*/
...
#define formatpin A0 // GPIO02 = D4, see https://randomnerdtutorials.com/esp8266-pinout-reference-gpios/
...
//U8G2_ST7567_ENH_DG128064I_F_SW_I2C u8g2(U8G2_R0, SCL, SDA, U8X8_PIN_NONE);
//U8G2_ST7567_ENH_DG128064I_1_HW_I2C u8g2(U8G2_R0, U8X8_PIN_NONE);
//U8G2_ST7567_OS12864_F_4W_SW_SPI u8g2(U8G2_R0, /* clock=*/ 14, /* data=*/ 13, /* cs=*/ 16, /* dc=*/ 5, /* reset=*/ 4); 
//U8G2_ST7567_ENH_DG128064_F_4W_SW_SPI u8g2(U8G2_R0, /* clock=*/ 14, /* data=*/ 13, /* cs=*/ 16, /* dc=*/ 5, /* reset=*/ 4); 
U8G2_ST7567_ENH_DG128064I_F_4W_SW_SPI u8g2(U8G2_R0, /* clock=*/ 14, /* data=*/ 13, /* cs=*/ 16, /* dc=*/ 5, /* reset=*/ 4); 
...
byte doispe = 0;  // 0 = 12-hour format, 1 -> 24-hour format
byte doispe0 = 1;

void setup()
{
    pinMode (DSTpin, INPUT);  // switch for DST
    pinMode (formatpin, INPUT);  // switch for 12/24-hour format
  ...
  //  u8g2.setFont(u8g2_font_ncenB08_tr); 
    u8g2.drawStr(20, 20, "NTP clock v.2b"); // write something to the internal memory  
    u8g2.drawStr(30, 40, "by niq_ro."); // write something to the internal memory  
    } while (u8g2.nextPage() );  
  //  u8g2.sendBuffer(); // transfer internal memory to the display
    ...
    do {
  //  u8g2.setFont(u8g2_font_profont12_mr); 
    u8g2.drawStr(20, 20, "NTP clock v.2a"); // write something to the internal memory 
    u8g2.drawStr(30, 40, "by niq_ro."); // write something to the internal memory   
    u8g2.drawStr(15, 60, "(set the Wi-Fi)"); // write something to the internal memory  
    } while (u8g2.nextPage() );  
    delay(1000);
   //WiFiManager
